(function webpackUniversalModuleDefinition(root, factory) {
	if(typeof exports === 'object' && typeof module === 'object')
		...
		define("xtate", [], factory);
	else if(typeof exports === 'object')
		exports["xtate"] = factory();
	else
		root["xtate"] = factory();
...
var EventSubscription = __webpack_require__(136);
...
var _fbemitter = __webpack_require__(134);

function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }

var Xtate = function (_EventEmitter) {
  (0, _inherits3.default)(Xtate, _EventEmitter);

  function Xtate() {
    var _this2 = this;

    var initialState = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : {};
    var logChanges = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : false;
    (0, _classCallCheck3.default)(this, Xtate);

    var _this = (0, _possibleConstructorReturn3.default)(this, (Xtate.__proto__ || (0, _getPrototypeOf2.default)(Xtate)).call(this));

    _this.updateStore = function (event, newState) {
      _this.store = newState;
      (0, _get3.default)(Xtate.prototype.__proto__ || (0, _getPrototypeOf2.default)(Xtate.prototype), 'emit', _this).call(_this, '_');
    ...
    _this.actionAsync = function (event, reducer) {
      return _this.createAction(event, function () {
          ...
          return _regenerator2.default.wrap(function _callee$(_context) {
            while (1) {
              switch (_context.prev = _context.next) {
                case 0:
                  _context.next = 2;
                  return reducer(_this.getStoreCopy(), payload);

                case 2:
                  result = _context.sent;


                  _this.updateStore(event, result);
    ...
    _this.action = function (event, reducer) {
      return _this.createAction(event, function (payload) {
        var result = reducer(_this.getStoreCopy(), payload);

        _this.updateStore(event, result);
      });
    };

    _this.dispatch = function (event, payload) {
      (0, _get3.default)(Xtate.prototype.__proto__ || (0, _getPrototypeOf2.default)(Xtate.prototype), 'emit', _this).call(_this, '_' + event, payload);
    };

    _this.connect = function (ChildComponent) {
      var xtate = _this;
      ...
      return function (_React$Component) {
        ...
        function _class() {
          ...
          var _this3 = (0, _possibleConstructorReturn3.default)(this, (_class.__proto__ || (0, _getPrototypeOf2.default)(_class)).call(this));

          _this3.state = xtate.store;
          return _this3;
        }
        ...
        (0, _createClass3.default)(_class, [{
          ...
          value: function componentDidMount() {
            ...
            this.listener = xtate.addListener('_', function () {
          ...
          value: function render() {
            return (
              ...
              _react2.default.createElement(ChildComponent, (0, _extends3.default)({ store: this.state }, this.props))
            );
          }
        }]);
        return _class;
    ...
    _this.store = initialState;
    _this.logChanges = logChanges;
    return _this;
  }

  (0, _createClass3.default)(Xtate, [{
    key: 'createAction',
    value: function createAction(event, callback) {
      var _this4 = this;

      (0, _get3.default)(Xtate.prototype.__proto__ || (0, _getPrototypeOf2.default)(Xtate.prototype), 'addListener', this).call(this, '_' + event, callback);

      return function (payload) {
        _this4.dispatch(event, payload);
      };
    }
  }, {
    key: 'getStoreCopy',
    value: function getStoreCopy() {
      return (0, _assign2.default)({}, this.store);
    }
  }]);
  return Xtate;
}(_fbemitter.EventEmitter);

exports.default = Xtate;
...
module.exports = {
  set: Object.setPrototypeOf || ('__proto__' in {} ? // eslint-disable-line
    function (test, buggy, set) {
      try {
        set = __webpack_require__(13)(Function.call, __webpack_require__(38).f(Object.prototype, '__proto__').set, 2);
        set(test, []);
...
var m=__webpack_require__(61),n=__webpack_require__(62),p=__webpack_require__(23),q="function"===typeof Symbol&&Symbol["for"],r=q?Symbol["for"]("react.element"):60103,t=q?Symbol["for"]("react.call"):60104,u=q?Symbol["for"]("react.return"):60105,v=q?Symbol["for"]("react.portal"):60106,w=q?Symbol["for"]("react.fragment"):60107,x="function"===typeof Symbol&&Symbol.iterator;
...
var fbemitter = {
  EventEmitter: __webpack_require__(135),
...
var EventSubscriptionVendor = __webpack_require__(137);
