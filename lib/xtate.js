...
var EventSubscription = __webpack_require__(131);
...
var _fbemitter = __webpack_require__(129);

function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }

var Xtate = exports.Xtate = function (_EventEmitter) {
  ...
  function Xtate() {
    ...
    _this.updateStore = function (event, newState) {
      ...
      (0, _get3.default)(Xtate.prototype.__proto__ || (0, _getPrototypeOf2.default)(Xtate.prototype), 'emit', _this).call(_this, 'update' + event);
    ...
    _this.actionAsync = function (event, reducer) {
      (0, _get3.default)(Xtate.prototype.__proto__ || (0, _getPrototypeOf2.default)(Xtate.prototype), 'addListener', _this).call(_this, event, function () {
          ...
          return _regenerator2.default.wrap(function _callee$(_context) {
            while (1) {
              switch (_context.prev = _context.next) {
                case 0:
                  _context.next = 2;
                  return reducer(_this.store, payload);
    ...
    _this.action = function (event, reducer) {
      (0, _get3.default)(Xtate.prototype.__proto__ || (0, _getPrototypeOf2.default)(Xtate.prototype), 'addListener', _this).call(_this, event, function (payload) {
        var result = reducer(_this.store, payload);
    ...
    _this.dispatch = function (event, payload) {
      (0, _get3.default)(Xtate.prototype.__proto__ || (0, _getPrototypeOf2.default)(Xtate.prototype), 'emit', _this).call(_this, event, payload);
    };
    ...
    _this.connect = function (ChildComponent) {
      ...
      return function (_React$Component) {
        ...
        function _class() {
          ...
          _this3.state = reactEmitter.store;

          _this3.addListenerForEvents();
          return _this3;
        }

        (0, _createClass3.default)(_class, [{
          key: 'addListenerForEvents',
          value: function addListenerForEvents() {
            var component = this;

            events.forEach(function (e) {
              reactEmitter.addListener('update' + e, function () {
          ...
          value: function render() {
            return (
              ...
              _react2.default.createElement(ChildComponent, { global: this.state, local: this.props })
            );
          }
        }]);
        return _class;
...
module.exports = {
  set: Object.setPrototypeOf || ('__proto__' in {} ? // eslint-disable-line
    function (test, buggy, set) {
      try {
        set = __webpack_require__(12)(Function.call, __webpack_require__(36).f(Object.prototype, '__proto__').set, 2);
        set(test, []);
...
var m=__webpack_require__(59),n=__webpack_require__(60),p=__webpack_require__(21),q="function"===typeof Symbol&&Symbol["for"],r=q?Symbol["for"]("react.element"):60103,t=q?Symbol["for"]("react.call"):60104,u=q?Symbol["for"]("react.return"):60105,v=q?Symbol["for"]("react.portal"):60106,w=q?Symbol["for"]("react.fragment"):60107,x="function"===typeof Symbol&&Symbol.iterator;
...
var fbemitter = {
  EventEmitter: __webpack_require__(130),
...
var EventSubscriptionVendor = __webpack_require__(132);
